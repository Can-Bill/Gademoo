...
<h1 class="app-page-title">Employé(e)s</h1>
  ...
  <circle cx="8" cy="4.5" r="1"/>
									    ...
									    <input type="text" class="form-control" id="setting-input-1" placeholder="Entre le nom de l'employé(e)" name="nom" required value="{{old('nom')}} ">
									...
									<div class="mb-3">
									    ...
									    <input type="text" class="form-control" id="setting-input-2" placeholder="Entrer le prenom de l'employé" name="prenom" required value="{{old('prenom')}} ">
									</div>
								    <div class="mb-3">
			  						    <label for="setting-input-3" class="form-label">Email</label>
									    <input type="email" class="form-control" id="setting-input-3" placeholder="hello@companywebsite.com" name="email" value="{{old('email')}}">
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="text" class="form-control" id="setting-input-3" placeholder="Entrer le contact" name="contact" value="{{old('contact')}} ">
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="text" class="form-control" id="setting-input-3" placeholder="Entrer le montant journalier" name="montant_journalier" value="{{old('montant_journalier')}} ">
